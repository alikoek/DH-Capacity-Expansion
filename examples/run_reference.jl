...
# Simulation settings
ITERATION_LIMIT = 200        # Number of SDDP training iterations
...
##
##################################################################
# EV execution: getting the solution of the expected value problem
##################################################################
println("======================")
println("EXPECTED VALUE PROBLEM")
println("======================")
...
params = load_parameters(excel_file,ref)
...
ref_model = build_sddp_model(params, data)
...
SDDP.write_log_to_csv(ref_model,joinpath(output_dir, "training_results_ref.csv"))
...
results_file = joinpath(output_dir, "reference", "simulation_results.txt")
export_results(simulations, params, data, results_file)

# # Generate visualizations
generate_visualizations(simulations, params, data, output_dir="output/reference")

println()
println("======================")
println("EXPECTED VALUE SOLVED")
println("======================")
